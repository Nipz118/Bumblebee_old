...
<div class="panel panel-default checkout-step-01">
	...
	<div id="collapseOne" class="panel-collapse collapse in">
	    ...
	    <input type="radio" name="paymethod" value="COD" checked="checked"> Cash On Delivery <br /><br />
	     <input type="radio" name="paymethod" value="Debit / Credit card"> Debit / Credit card Payment <br /><br />
                    ...
                    <div class="panel-heading">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
								<h4> - online card details - </h4>
                                <h5 class="text-muted"> Debit/ Credit Card Number *</h5>
                            </div>
